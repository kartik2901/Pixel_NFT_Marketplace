...
const SIGNING_DOMAIN_NAME = "dabblerNft";
...
class orderhash {
  ...
  async createVoucher(nftAddress: any, seller: any, amount: any, tokenId: any, 
    pricePerShare: any,counter: any, royaltyFee: any, isPrimary: any, tokenUri:any ) {
    const Voucher = {nftAddress, seller, amount, tokenId, pricePerShare, counter, royaltyFee, isPrimary, tokenUri}
  ...
  async createOffer(offernumber : any , tokenId : any , offerMaker : any , offerAccepter : any 
    , offerAmount : any , askedQuantity : any){
